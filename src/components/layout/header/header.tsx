...
const Header = () => {
  ...
  return (
    <header className="bg-panel border-b border-border sm:px-6 px-3 py-3.5 flex flex-wrap items-center gap-3 shadow-sm select-none not-dark:border-b-border z-50">
      {/* Logo */}
